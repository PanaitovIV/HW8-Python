...
def main():
    ...
    while action != 0:
        print(f'Выберите интересующее Вас действие: \n' '1 - Вывести информацию на экран \n' 
              '2 - Произвести добавление данных \n' '3 - Произвести изменение данных \n'
              '4 - Произвести удаление данных \n' '0 - Выход из программы \n')
        action = int(input("Действие: "))
        while action < 0 or action > 4:
            print('Была допущена ошибка, под введенным Вами номером нет действий!')
            action = int(input('Введите верный номер: '))
        if action == 1:
            show_data(file_tel)
        elif action == 2:
    ...
    print("До скорых встреч, будем ждать Вас вновь.")
